          ...
          {showOnlineUsers && (
            ...
            >
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto">
                ...
                {onlineUsers.size === 0 && (
                  <p className="text-sm text-gray-500 text-center py-2">No one online</p>
                )}
              </div>
            </motion.div>
          )}
          ...
          {loading ? (
            ...
            >
              ...
              <p className="text-gray-500 max-w-xs">
                Start the conversation about {event.title}!
              </p>
            </motion.div>
          ) : (
                        ...
                        >
                          {msg.system ? (
                            ...
                            <div className={`flex items-end space-x-2 max-w-[85%] ${
                              ...
                              {/* Avatar */}
                              {showAvatar && (
                                <div className="w-8 h-8 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                              ...
                              <div className={`flex flex-col ${
                                ...
                                >
                                  ...
                                  <div className={`text-xs mt-1 ${
                                    isCurrentUserMsg ? 'text-green-100' : 'text-gray-400'
                                  }`}>
          ...
          <form onSubmit={handleSendMessage} className="flex space-x-3">
            <div className="flex-1 relative">
              <input
                ...
                placeholder={`Message about ${event.title}...`}
                className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 pr-12"
                maxLength={500}
              />
              {newMessage.length > 0 && (
            ...
            <motion.button
              ...
              className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-3 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none"
            >
              {isSending ? (
