        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <textarea
              ...
              maxLength={500}
              rows={4}
              className={`w-full px-4 py-4 bg-gray-50 border-2 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-300 resize-none ${
